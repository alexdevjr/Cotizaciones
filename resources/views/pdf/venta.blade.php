...
<html>
    ...
    <body>
        ...
        <header>
            <div id="logo">
                <img src="img/logo2.png" alt="Software Web SAS" id="imagen">
            </div>
            <div id="datos">
                <p id="encabezado">
                    <b>Software Web SAS</b><br>Transversal 32 Sur # 32B - 38 - Magnolia - Medellín, Colombia<br>Telefono:(+57)(4)5798601<br>Email: info@swebsas.com
                </p>
            </div>
            <div id="fact">
